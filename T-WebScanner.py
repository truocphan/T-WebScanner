...
if __name__ == '__main__':
	...
	if OS in ['Windows', 'Linux'] and PythonVersion[0] == '3':
		...
		exit(Fore.RED + " Please use " + Style.RESET_ALL + Back.GREEN + "python 3.x.x" + Style.RESET_ALL + Fore.RED + " to run T-WebScanner and run on " + Style.RESET_ALL + Back.GREEN + "Windows" + Style.RESET_ALL + Fore.RED + " or " + Style.RESET_ALL + Back.GREEN + "Linux" + Style.RESET_ALL + "\n")